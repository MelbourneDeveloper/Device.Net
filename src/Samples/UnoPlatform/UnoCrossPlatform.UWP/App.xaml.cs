...
namespace UnoCrossPlatform
{
    ...
    public sealed partial class App : Application
    {
        ...
        public App()
        {
            //TODO: Implement ConfigureFilters
...
#pragma warning restore Uno0001 // Uno type or member is not implemented
        ...
        private void OnNavigationFailed(object sender, NavigationFailedEventArgs e) => throw new Exception($"Failed to load {e.SourcePageType.FullName}: {e.Exception}");
