...
namespace Usb.Net
{
    public class UsbDevice : DeviceBase, IUsbDevice
    {
        ...
        /// </summary>
        public UsbDevice(string deviceId, IUsbInterfaceManager usbInterfaceManager, ILoggerFactory loggerFactory) : base(deviceId, loggerFactory, loggerFactory.CreateLogger<UsbDevice>())
        {
