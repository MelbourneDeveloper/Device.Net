...
#pragma warning restore CA2000
                WindowsHelpers.HandleError(isSuccess, Messages.ErrorMessageCouldntIntializeDevice, Logger);
...
#pragma warning restore CA2000
        ...
        private WindowsUsbInterface GetInterface(SafeFileHandle interfaceHandle)
        {
            ...
            WindowsHelpers.HandleError(isSuccess, "Couldn't query interface", Logger);
            ...
            for (byte i = 0; i < interfaceDescriptor.bNumEndpoints; i++)
            {
                ...
                WindowsHelpers.HandleError(isSuccess, "Couldn't query endpoint", Logger);
...
#pragma warning restore IDE0059 // Unnecessary assignment of a value
            WindowsHelpers.HandleError(isSuccess2, "Couldn't get device descriptor", logger);
