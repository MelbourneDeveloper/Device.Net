...
namespace Usb.Net
{
    ...
    {
        public static Task<ControlTransferResult> SendControlTransferAsync(this IUsbDevice usbDevice, SetupPacket setupPacket, byte[] buffer = null, CancellationToken cancellationToken = default)
