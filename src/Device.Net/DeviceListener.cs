...
{
    /// <summary>
    /// Handles connection of devices. This is not the recommended approach. Please use DeviceManager where possible. Documentation: <see href="https://docs.microsoft.com/en-us/dotnet/api/microsoft.extensions.logging.iloggerfactory"/>
    /// </summary>
