...
namespace Device.Net.UnitTests
{
    ...
    public class HidTests
    {
        ...
        public void TestDeviceIdInvalidException()
        {
            try
            {
                _ = new WindowsHidHandler(null, (a) => default, (a, b) => default);
            }
        ...
        private static async Task<WindowsHidHandler> InitializeWindowsHidDevice(bool isReadonly)
        {
            ...
            var windowsHidDevice = new WindowsHidHandler(deviceId, (a) => default, (a, b) => default, loggerFactory: loggerFactory.Object, hidApiService: hidService.Object);
